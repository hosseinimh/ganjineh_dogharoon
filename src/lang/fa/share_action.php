...
return [
    ...
    'share_not_last' => 'تنها حذف آخرین تراکنش سهام، امکان‌پذیر است.',
    'share_not_last_date' => 'ثبت تراکنش سهام، تنها پس از تاریخ :field امکان‌پذیر است.',
    'share_not_same_date' => 'تاریخ پرداخت / دریافت سهام، تنها پس از تاریخ :field امکان‌پذیر است.',
];
